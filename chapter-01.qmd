...
table_onetwo_body <- tribble(
  ...
  'Strongly altered by long and intensive agricultural use:', 'Anthrosols', 'AT',
  ...
  'Dark topsoil, no secondary carbonates (unless very deep), high base saturation:', 'Phaeozems', 'PH',
  'Dark topsoil, low base saturation:', 'Umbrisols', 'UM',
