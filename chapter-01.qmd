...
-   The contents of the book were rearranged:
    ...
    -   The new [Annex 6](annex-06-rsg-colors.qmd) gives recommendations for colour symbols for Reference Soil Group maps.
...
### General principles {#sec-bspr-gen}
...
| mollic horizon  | thick, dark-coloured, high base saturation, moderate to high content of organic matter, at least some soil structure or structural elements created by agicultural practices                                                          |
...
| duric horizon         | concretions or nodules, cemented by secondary silica, and/or fragments of a broken-up petroducirc horizon                                                                                                                                                              |
...
| limnic material        | deposited in water by precipitation (possibly with sedimentation), or derived from algae, or derived from aquatic plants with subsequent transport or subsequent modification by aquatic animals or microorganisms |
...
: Simplified guide to the WRB Reference Soil Groups (RSGs) with suggested codes. **This table is not to be used as a key**. For full definitions, please refer to [Chapter 3](chapter-03.qmd) and the Key ([Chapter 4](chapter-04.qmd)). {#tbl-rsgcodes}
