...
#| results: hold
#| label: tbl-twoone
#| tbl-cap: Detection of dominant, codominant and associated soils.
...
tbl21 <- gt(table_twoone_body) |>
  cols_label(CSN = 'Complete soil name') |>
  tab_options(
...
#| results: hold
#| label: tbl-twotwo
#| tbl-cap: Denomination of the map unit depending on the scale level.


table_twotwo_body <- tribble(
  ~Mscale, ~dsoil, ~cdsoil, ~asoil,
  'First', 'Luvisols', 'Cambisols', NA,
...
tbl22 <- gt(table_twotwo_body) |>
  cols_label(Mscale = 'Map scale level',
             dsoil  = 'Dominant soil',
             cdsoil = 'Codominant soil',
             asoil  = 'Associated soil') |>
