# The rules for naming soils and creating legends for soil maps
...
9.  On a **slope**, the soil is described as a vertical profile. The thickness and depth values are calculated by multiplying the vertically measured values by the cosine of the inclination angle (see Annex 1, Chapter 8.1.2) (Prietzel & Wiesmeier, 2019). This is especially important on steep slopes.
...
The **principal qualifiers** are ranked and given in an order of importance. The rank of the principal qualifiers reflects particular soil chacracteristics or properties strongly influencing the soil's functionality:
...
![Specifiers to construct optional subqualifiers related to depth requirements and referring to a particular layer (Bathy- not illustrated), modified by S. Dondeyne](Figure_2-1.png){#fig201 fig-alt="Specifiers to construct optional subqualifiers related to depth requirements and referring to a particular layer (Bathy- not illustrated), modified by S. Dondeyne"}
...
![Soils in a landscape that need to be combined to form a map unit](Figure_2-2.png){#fig202 fig-alt="Soils in a landscape that need to be combined to form a map unit"}
