...
|                               |             |             |           |           |
|---------------|---------------|---------------|---------------|---------------|
| [Histosols](#key-histosols)   | Solonchaks  | Nitisols    | Gypsisols | Cambisols |
| [Anthrosols](#key-anthrosols) | Gleysols    | Ferralsols  | Calcisols | Fluvisols |
...
1.  one of the following:
    ...
    b.  \< 20% (by volume, related to the whole soil) fine earth[^chapter-04-2], averaged over a depth of 75 cm from the soil surface or to *continuous rock*, whichever is shallower; *and*
2.  no *chernic*, *duric*, *petrocalcic*, *petroduric*, *petrogypsic*, *petroplinthic*, *pisoplinthic* or *spodic horizon*.

[^chapter-04-2]: The volume not occupied by fine earth is occupied by coarse fragments or pores.
...
## Andosols[^chapter-04-3] {#key-andosols .unnumbered}

[^chapter-04-3]: Andosols may bury other soils, which can be mentioned behind the Andosol classification using the word 'over' in between (see Chapter 2.4). Alternatively, buried diagnostic horizons or buried layers with a diagnostic property can be indicated with the Thapto- specifier followed by a qualifier.
...
2.  starting ≤ 50 cm below the lower limit of the *mollic*[^chapter-04-4] *horizon* and, if present, above a *petrocalcic horizon*, a layer with *protocalcic properties*, ≥ 5 cm thick, or a *calcic horizon*; *and*
3.  a base saturation (by 1 *M* NH~4~OAc, pH 7)[^chapter-04-5] of ≥ 50% from the mineral soil surface to the layer with *protocalcic properties* or to the *calcic horizon*, throughout.

[^chapter-04-4]: Any *chernic horizon* also meets the criteria of a *mollic horizon*. The *mollic horizon* may extend below the *chernic horizon*.
...
3.  a base saturation (by 1 *M* NH~4~OAc, pH 7)[^chapter-04-6] of ≥ 50% from the mineral soil surface to the layer with *protocalcic properties* or to the *calcic horizon*, throughout.

[^chapter-04-6]: If the data for base saturation are not available, pH values may be used according to Annex 2 (Chapter 9.13).
...
1.  a *mollic horizon*; *and*
2.  a base saturation (by 1 *M* NH~4~OAc, pH 7)[^chapter-04-7] of ≥ 50% throughout to a depth of 100 cm from the mineral soil surface or to a limiting layer, whichever is shallower.

[^chapter-04-7]: If the data for base saturation are not available, pH values may be used according to Annex 2 (Chapter 9.13).
...
3.  exchangeable Al \> exchangeable (Ca+Mg+K+Na)[^chapter-04-8] in half or more of:
...
[^chapter-04-8]: Exchangeable cations are given in cmol~c~ kg^-1^. If these data are not available, pH values may be used according to Annex 2 (Chapter 9.13).
...
1.  an *argic horizon* starting ≤ 100 cm from the mineral soil surface; *and*
2.  exchangeable Al \> exchangeable (Ca+Mg+K+Na)[^chapter-04-9] in half or more of:
    a.  the depth range between 50 and 100 cm of the mineral soil surface; *or*
    b.  the lower half of the mineral soil above a limiting layer starting ≤ 100 cm from the mineral soil surface whichever is shallower.

[^chapter-04-9]: Exchangeable cations are given in cmol~c~ kg^-1^. If these data are not available, pH values may be used according to Annex 2 (Chapter 9.13).
