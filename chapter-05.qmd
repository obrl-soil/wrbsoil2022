...
(from Latin *positivus*, given): having a layer, ≥ 30 cm thick and starting ≤ 100 cm from the mineral soil surface, that has a zero or positive charge (pH~KCl~ - pH~water~ ≥ 0, both in 1:1 solution) (2).
...
(from French *profond*, deep): having an [*argic horizon*](chapter-03.qmd#sec-argich), in which the clay content does not decrease by ≥ 20% (relative) from its maximum down to 150 cm of the mineral soil surface, throughout.
...
(from Latin *silex*, silicon-containing material, and Japanese *an*, dark, and *do*, soil): having within 100 cm of the soil surface one or more layers with a combined thickness of ≥ 15 cm with [*andic properties*](chapter-03.qmd#sec-andicp) and a Si~ox~ content of ≥ 0.6% (2).
...
(from Greek *proton*, first): having a layer, starting ≤ 100 cm from the mineral soil surface, that has a pH~water~ of \< 4.6 and has an Al~ox~ value of ≥ 0.5% that is ≥ 1.5 times that of the lowest Al~ox~ value of all the mineral layers above; and not having a [*spodic horizon*](chapter-03.qmd#sec-spodich) starting ≤ 200 cm from the mineral soil surface (2).

### Spolic (sp) {#sec-sp .unnumbered}

(from Latin *spoliare*, to exploit): having a layer, ≥ 20 cm thick and within 100 cm of the soil surface, with ≥ 20% (by volume, weighted average, related to the whole soil) [*artefacts*](chapter-03.qmd#sec-artefm), ≥ 35% of which consist of industrial products (e.g. mine spoil, dredgings, slag, ash, rubble, etc.) (in [*Technosols*](chapter-04.qmd#sec-key-tc) only) (2).
...
-   and having a slope inclination of ≥ 5% and a subsurface water flow for some time during the year (2).
...
(from Latin *urbs*, city): having a layer, ≥ 20 cm thick and within 100 cm of the soil surface, with ≥ 20% (by volume, weighted average, related to the whole soil) [*artefacts*](chapter-03.qmd#sec-artefm), ≥ 35% of which consist of rubble and refuse of human settlements (in [*Technosols*](chapter-04.qmd#sec-key-tc) only) (2).
