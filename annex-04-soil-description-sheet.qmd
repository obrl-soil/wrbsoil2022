...
The soil description sheet is provided as an open-access excel file on the [WRB homepage](https://wrb.isric.org/documents/). For cells coloured in brown, a code is required. For cells coloured in green, figures or free text are required. The excel file representing the whole Annexes 1 ([Chapter 8](annex-01-field-guide.qmd)) and 3 ([Chapter 10](annex-03-horizon-layer-designations.qmd)) is relatively long.
