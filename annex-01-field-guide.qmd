...
![Ideal soil scientists](images/figure_8-1.png)

## Preparation work and general rules {#sec-a1-prep}

### Exploration of an area of interest with auger and spade {#sec-a1-expl}

::: {grid}
::: {grid-col-4}
![Pürckhauer auger profile](images/figure_8-2.png)

![Mini-profile](images/figure_8-3.png)
:::
...
In most cases, the topsoil falls out of the auger. To investigate it in more detail, always make a mini-profile close to where the auger was driven in. It should be at least 25 cm deep and wide, and the profile walls should be vertical and smooth. Now place a folding ruler inside the profile in such a way that point 0 is at the soil surface (see [Chapter 8.3.1](#sec-a1-ssurf)). For later reconstruction, it may help to take a picture of the mini-profile (Figure 8.3).

The characteristics that can be described from the soil material in the auger are marked with an asterisk (\*) in [Chapter 8.4](#sec-a1-lyrs).
:::
:::

### Preparation of a soil profile {#sec-a1-dig}

The soil profile should be at least 1 m deep or reach the parent material. On a slope, unless the parent material starts at smaller depth, the profile depth (Figure 8.4) should be 1 m / cos(α). For the decision if the thickness and depth criteria of the WRB are fulfilled and when calculating element stocks [@prietzel2019] the layer thickness perpendicular to the slope is needed. This is calculated multiplying the vertical thickness by cos(α).

![Correct profile depth when terrain is inclined](images/figure_8-4.png)
...
![The setting of the profile in the landscape](images/figure_8-6.png)
...
This Chapter refers to the large-scale topography. For local surface unevenness, see [Chapter 8.3.11](#sec-a1-unev).
...
![Slope aspect, Schoeneberger et al. [-@schoeneberger2012], 1-5](images/figure_8-7.png)
...
![Slope Shape, Schoeneberger et al. [-@schoeneberger2012], 1-6](images/figure_8-8.png)

#### Position of the soil profile (related to topography)

If the profile lies in an uneven terrain, report the profile position.

![Position of the profile, Schoeneberger et al. [-@schoeneberger2012], 1-7, modified (basin not included)](images/figure_8-9.png)
...
: Climate according to Köppen [-@köppen1936]
...
: Ecozones according to Schultz [-@schultz2005, adapted]
...
: Current weather conditions, Schoeneberger et al. [-@schoeneberger2012], 1-1
...
: Vegetation strata, National Committee on Soil and Terrain [-@nationalcommitteeonsoilandterrain2009], 79, modified
...
: Vegetation type, National Committee on Soil and Terrain [-@nationalcommitteeonsoilandterrain2009], 88-93, modified
...
### Litter layer {#sec-a1-llyr}

Observe an area of 5 m x 5 m with the profile at its centre. Report the average and the maximum thickness of the litter layer in cm (see [Chapter 8.3.1](#sec-a1-ssurf)). If there is no litter layer, report 0 cm as thickness.
...
### Coarse surface fragments {#sec-a1-scf}
...
: Size of coarse surface fragments, FAO [-@un-fao2006], Table 15
...
: Width of surface cracks, FAO [-@un-fao2006], Table 21
...
: Distance between surface cracks, FAO [-@un-fao2006], Table 21, modified
...
### Surface unevenness {#sec-a1-unev}
...
![Human-made surface alterations](images/figure_8-10.png)
...
: Categories of erosion, FAO [-@un-fao2006], Table 16
...
: Degree of erosion, FAO [-@un-fao2006], Table 18
...
: Activity of erosion, FAO [-@un-fao2006], Table 19
...
## Description of layers {#sec-a1-lyrs}
...
: Soil water status, FAO [-@un-fao2006], Table 57, modified

### Organic, organotechnic and mineral layers {#sec-a1-orgl}
...
: Distinctness of layer boundaries, Schoeneberger et al. [-@schoeneberger2012], 2-6, modified
...
: Shape of layer boundaries, Schoeneberger et al. [-@schoeneberger2012], 2-7

![Shape of layer boundaries, Schoeneberger et al. [-@schoeneberger2012], 2-7, modified](images/figure_8-11.png)
...
: Size and shape classes of coarse fragments, FAO [-@un-fao2006], Tables 27 and 28
...
: Weathering stage of coarse fragments, FAO [-@un-fao2006], Table 29
...
![Charts for estimating percentages of coarse fragments, FAO [-@un-fao2006], Figure 5, modified by B. Repe](images/figure_8-12.png)
...
: Examples of artefacts, Schoeneberger et al. [-@schoeneberger2012], 2-50, modified
...
: Size of artefacts, FAO [-@un-fao2006], Table 27
...
: Particle-size classes, ISO 11277:2009 [@internationalorganizationforstandardization2015]
...
![Texture classes, triangle, Blum et al. [-@blum2018], Figure 28, modified](images/figure_8-13.png)
...
: Texture classes, Soil Science Division Staff [-@soilsciencedivisionstaff2017].

![Texture classes, flow chart, ideas adapted from - Natural England Technical Information Note TIN037 [-@naturalengland2008] - Thien [-@thien1979]](images/figure_8-14.png)
...
![General terms of soil aggregate description](images/figure_8-15.png)
...
: Grade of structural units, Soil Science Division Staff [-@soilsciencedivisionstaff2017], 159f, modified
...
: Aggregate size, Schoeneberger et al. [-@schoeneberger2012], 2-55, FAO [-@un-fao2006], Table 50, modified
...
### Pores and cracks (overview) {#sec-a1-pc}
...
### Non-matrix pores (m) {#sec-a1-pores}
...
: Types of non-matrix pores, Schoeneberger et al. [-@schoeneberger2012], 2-73, modified

Tubular and dendritic tubular pores are commonly referred to as **biopores**.

![Type of non-matrix pores, Schoeneberger et al. [-@schoeneberger2012], 2-74](images/figure_8-16.png)
...
: Abundance of pores, Schoeneberger et al. [-@schoeneberger2012], 2-70, modified
...
: Persistence of cracks, Schoeneberger et al. [-@schoeneberger2012], 2-76
...
### Stress features (m) {#sec-a1-stress}
...
![Type of stress features, Schoeneberger et al. [-@schoeneberger2012], 2-34](images/figure_8-17.png)
...
: Types of concentrations (overview), Soil Science Division Staff. [-@soilsciencedivisionstaff2017], page 174f
...
![Colour flow chart, Schoeneberger et al. [-@schoeneberger2012], 2-8, modified](images/figure_8-18.png)
...
: Size of lithogenic mottles, FAO [-@un-fao2006], Table 33

#### Abundance (by exposed area)

Report the percentage of abundance.

### Redoximorphic features (m) {#sec-a2-redox}
...
: Size of oximorphic features, FAO [-@un-fao2006], Table 33
...
: Consistence of oximorphic features, Schoeneberger et al. [-@schoeneberger2012], 2-63
...
: Ranges of rH values and related soil processes as derived from redoximorphic features and from field tests of reducing conditions, Blume et al. [-@blume2010], page 24, FAO [-@un-fao2006], Table 36, modified
...
### Coatings and bridges (m) {#sec-a1-coats}
...
![Clay coatings and clay bridges, Schoeneberger et al. [-@schoeneberger2012], 2-34](images/figure_8-20.png)
...
: Carbonate contents, FAO [-@un-fao2006], Table 38
...
: Gypsum contents in layers with little readily soluble salts, FAO [-@un-fao2006], Table 40
...
### Secondary silica (m) {#sec-a1-silica}
...
: Estimation of the water content of the saturation extract of mineral layers, DVWK [-@bodenkun1995], FAO [-@un-fao2006], Table 43
...
: Estimation of the water content of the saturation extract of organic layers, DVWK [-@bodenkun1995], FAO [-@un-fao2006], Table 43
...
: Cementation, Schoeneberger et al. [-@schoeneberger2012], 2-63
...
: Rupture resistance, non-cemented soil, Schoeneberger et al. [-@schoeneberger2012], 2-63
...
: Types of manner of failure (brittleness), Schoeneberger et al. [-@schoeneberger2012], 2-65
...
: Types of plasticity, Schoeneberger et al. [-@schoeneberger2012], 2-66
...
### Continuity of hard materials and cemented layers (m)
...
### Volcanic glasses and andic characteristics (o, m)
...
With the following Figure, the bulk density is determined from packing density and soil texture (see Chapter 8.4.9). If C~org~ content is \> 1%, bulk density must be reduced by 0.03 kg dm^-3^ for each 0.5% increment in C~org~ content. Report the bulk density with an accuracy of one decimal.

![Estimation of bulk density from packing density and texture, FAO [-@un-fao2006], Figure 7, modified](images/figure_8-21.png){fig-align="center"}

### Soil organic carbon (C~org~) (m)
...
: Estimation of organic carbon contents in a moist sample, Blume et al. [-@blume2010], modified
...
: Abundance of roots, FAO [-@un-fao2006], Table 80

### Results of animal activity (o, m)
...
: Types of animal activity, FAO [-@un-fao2006], Table 82, modified

### Human alterations (o, m)
...
: Types of parent material, FAO [-@un-fao2006], Table 12, modified

If the type is unknown, just report the group. Note: the old terms 'acid' and 'basic' rocks were replaced by 'felsic' and 'mafic'.

### Degree of decomposition in organic layers and presence of dead plant remnants (o) (\*)
...
: Dead remnants of specific plants
...
### Sampling of terrestrial organic surface layers
...
### Conventional sampling of mineral layers
...
### Volumetric sampling of mineral layers
...
![Volumetric sampling](images/figure_8-22.png)
